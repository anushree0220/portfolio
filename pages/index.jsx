    ...
    <Layout pageClassName={"home"}>
            ...
            <div className="section hero-started">
              ...
              >
                <div className="titles">
                  ...
                  >
                    <span>
                      <b>{userData?.about?.name.split(" ")[0]}</b>{" "}
                      {userData?.about?.name.split(" ")[1]}{" "}
                    </span>
                  </h1>
                  <div className="label lui-subtitle">
                    {" "}
                    I am <strong>{userData?.about?.title}</strong>
                  </div>
                </div>
                ...
                <div className="bts">
                  <a
                    target="_blank"
                    href="https://drive.google.com/file/d/1BKU6p51-q9uNuS2-7DQnOedpmputtsaC/view?usp=sharing"
                    className="btn"
                  >
                  ...
                  <ul>
                    <li>
                      ...
                      <span className="value">
                         Month of<strong>Experience</strong>
                      </span>
                    </li>
                    <li>
                      <span className="num">{userData?.about?.some_total}</span>
                      <span className="value">
          ...
          <div className="container">
            ...
            >
              {userData?.services
                ...
                .map((service) => {
                  return (
                    <SwiperSlide className="swiper-slide" key={service._id}>
                      <div className="services-item">
                        ...
                        <a className="lnk">{service.charge}</a>
                        <div
                          className="image"
                          style={{
                            backgroundImage: "url(assets/images/pat-2.png)",
      ...
      <section className="lui-section lui-gradient-top" id="works-section">
        ...
        <div className="v-line v-line-right">
          <div className="container">
            <PortfolioIsotope
              projectCategories={userData.projectCategories}
              ...
              <div className="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <div className="numbers-items">
                  ...
                  >
                    ...
                    <div className="lui-text">
                      <span>{userData?.about?.phoneNumber}</span>
                    </div>
                  </div>
                </div>
              </div>
